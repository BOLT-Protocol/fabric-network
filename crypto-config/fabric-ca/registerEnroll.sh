...
function createDefaultOrg() {
  ...
  set -x
  fabric-ca-client enroll -u https://devpeer:devpeerpw@localhost:7054 --caname ca-default -M ${PWD}/crypto-config/peerOrganizations/default.com/peers/devpeer/msp --csr.hosts devpeer.default.com --tls.certfiles ${PWD}/crypto-config/fabric-ca/defaultOrg/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://devpeer:devpeerpw@localhost:7054 --caname ca-default -M ${PWD}/crypto-config/peerOrganizations/default.com/peers/devpeer/tls --enrollment.profile tls --csr.hosts devpeer.default.com --csr.hosts localhost --tls.certfiles ${PWD}/crypto-config/fabric-ca/defaultOrg/tls-cert.pem
  { set +x; } 2>/dev/null
...
function createAsusOrg() {
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:8054 --caname ca-asus -M ${PWD}/crypto-config/peerOrganizations/asus.com/peers/peer0.asus.com/msp --csr.hosts peer0.asus.com --tls.certfiles ${PWD}/crypto-config/fabric-ca/asusOrg/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:8054 --caname ca-asus -M ${PWD}/crypto-config/peerOrganizations/asus.com/peers/peer0.asus.com/tls --enrollment.profile tls --csr.hosts peer0.asus.com --csr.hosts localhost --tls.certfiles ${PWD}/crypto-config/fabric-ca/asusOrg/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:8054 --caname ca-asus -M ${PWD}/crypto-config/peerOrganizations/asus.com/peers/peer1.asus.com/msp --csr.hosts peer1.asus.com --tls.certfiles ${PWD}/crypto-config/fabric-ca/asusOrg/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:8054 --caname ca-asus -M ${PWD}/crypto-config/peerOrganizations/asus.com/peers/peer1.asus.com/tls --enrollment.profile tls --csr.hosts peer1.asus.com --csr.hosts localhost --tls.certfiles ${PWD}/crypto-config/fabric-ca/asusOrg/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer2:peer2pw@localhost:8054 --caname ca-asus -M ${PWD}/crypto-config/peerOrganizations/asus.com/peers/peer2.asus.com/msp --csr.hosts peer2.asus.com --tls.certfiles ${PWD}/crypto-config/fabric-ca/asusOrg/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer2:peer2pw@localhost:8054 --caname ca-asus -M ${PWD}/crypto-config/peerOrganizations/asus.com/peers/peer2.asus.com/tls --enrollment.profile tls --csr.hosts peer2.asus.com --csr.hosts localhost --tls.certfiles ${PWD}/crypto-config/fabric-ca/asusOrg/tls-cert.pem
  { set +x; } 2>/dev/null
...
function createOrderer() {
  ...
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/crypto-config/ordererOrganizations/default.com/orderers/orderer.default.com/msp --csr.hosts orderer.default.com --csr.hosts localhost --tls.certfiles ${PWD}/crypto-config/fabric-ca/ordererOrg/tls-cert.pem
  { set +x; } 2>/dev/null
