...
function createOrg {
    ...
    # mkdir -p organizations/peerOrganizations/$ORG/peers/peer1.$ORG
    ...
    cp ${PWD}/organizations/peerOrganizations/org1.example.com/msp/config.yaml${PWD}/organizations/peerOrganizations/$ORG/peers/$USER.$ORG/msp/config.yaml
    
    # echo
    # echo "## Generate the peer0-tls certificates"
    # echo
    # set -x
    # fabric-ca-client enroll -u https://peer0:peer0pw@localhost:7054 --caname ca-org1 -M ${PWD}/organizations/peerOrganizations/$ORG/peers/peer0.$ORG/tls --enrollment.profile tls --csr.hosts peer0.$ORG--csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
    # set +x
    # echo
    # echo "## Generate the peer1-tls certificates"
    # echo
    # set -x
    # fabric-ca-client enroll -u https://peer1:peer1pw@localhost:7054 --caname ca-org1 -M ${PWD}/organizations/peerOrganizations/$ORG/peers/peer1.$ORG/tls --enrollment.profile tls --csr.hosts peer1.$ORG--csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
    # set +x
    
    
    cp ${PWD}/organizations/peerOrganizations/$ORG/peers/$USER.$ORG/tls/tlscacerts/*${PWD}/organizations/peerOrganizations/$ORG/peers/$USER.$ORG/tls/ca.crt
    cp ${PWD}/organizations/peerOrganizations/$ORG/peers/$USER.$ORG/tls/signcerts/*${PWD}/organizations/peerOrganizations/$ORG/peers/$USER.$ORG/tls/server.crt
    cp ${PWD}/organizations/peerOrganizations/$ORG/peers/$USER.$ORG/tls/keystore/*${PWD}/organizations/peerOrganizations/$ORG/peers/$USER.$ORG/tls/server.key
    ...
    mkdir ${PWD}/organizations/peerOrganizations/$ORG/msp/tlscacerts
    cp ${PWD}/organizations/peerOrganizations/$ORG/peers/$USER.$ORG/tls/tlscacerts/*${PWD}/organizations/peerOrganizations/$ORG/msp/tlscacerts/ca.crt
    
    mkdir ${PWD}/organizations/peerOrganizations/$ORG/tlsca
    cp ${PWD}/organizations/peerOrganizations/$ORG/peers/$USER.$ORG/tls/tlscacerts/*${PWD}/organizations/peerOrganizations/$ORG/tlsca/tlsca.$ORG-cert.pem
    
    mkdir ${PWD}/organizations/peerOrganizations/$ORG/ca
    cp ${PWD}/organizations/peerOrganizations/$ORG/peers/$USER.$ORG/msp/cacerts/*${PWD}/organizations/peerOrganizations/$ORG/ca/ca.$ORG-cert.pem
    
    mkdir -p organizations/peerOrganizations/$ORG/users
    mkdir -p organizations/peerOrganizations/$ORG/users/User1@$ORG
